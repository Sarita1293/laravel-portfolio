            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-ui">
              <article class="portfolio-entry">
                <figure class="entry-image">
                  <img src="{{ asset('assets/img/portfolio/'.$project->thumbnail_image) }}" class="img-fluid" alt="" loading="lazy">
                  <div class="entry-overlay">
                    <div class="overlay-content">
                      ...
                      <div class="entry-links">
                        ...
                        <a href="{{ asset('assets/img/portfolio/'.$project->thumbnail_image) }}" class="glightbox" data-gallery="portfolio-gallery-ui" data-glightbox="title: {{ $project->title }}; description: {{ $project->short_description }}">
                          <i class="bi bi-arrows-angle-expand"></i>
                        </a>
                        <a href="portfolio-pajasa-app.html">
